...
## Project Structure
    ...
    ├── testbackendprd_dev_42312  # Django project configurations
...
1. Clone this repo and `cd testbackendprd_dev_42312`
...
2. Clone this repo and `cd testbackendprd_dev_42312`
